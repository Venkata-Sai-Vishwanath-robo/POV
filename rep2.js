...
const delaySlider = document.getElementById("delaySlider"); // Get the slider element
const sliderValue = document.getElementById("sliderValue"); // Get the value display element

let currentDelay = 1000; // Initial delay value

// ... Rest of your code ...

// Function to update the delay value when the slider changes
delaySlider.addEventListener("input", function() {
  currentDelay = parseInt(this.value); // Parse the slider value as an integer
  sliderValue.textContent = currentDelay + " ms"; // Update the display
});

// ... Rest of your code ...

// Use currentDelay variable in your await delay() function
async function E() {
...
const ledFunctions = {
    ...
    // Get the range input element and the p elements (circles)
